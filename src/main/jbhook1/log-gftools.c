...
static int CDECL my_GFReportPuts(int level, const char* source_file, int a3, 
        const char* func, const char* msg);

static int (CDECL *real_GFReportPuts)(int level, const char* source_file,
        int a3, const char* func, const char* msg);
