...
#define CORE_PROPERTY_NODE_RESULT_IS_ERROR(x) (x > CORE_PROPERTY_RESULT_SUCCESS)
...
typedef core_property_node_result_t (*core_property_node_size_t)(const core_property_node_t *node, size_t *size);
typedef core_property_node_result_t (*core_property_node_search_t)(const core_property_node_t *node, const char *path, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_next_result_search_t)(const core_property_node_t *node, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_child_get_t)(const core_property_node_t *node, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_next_sibling_get_t)(const core_property_node_t *node, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_void_create_t)(const core_property_node_t *parent_node, const char *key, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_s8_create_t)(const core_property_node_t *parent_node, const char *key, int8_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_u8_create_t)(const core_property_node_t *parent_node, const char *key, uint8_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_s16_create_t)(const core_property_node_t *parent_node, const char *key, int16_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_u16_create_t)(const core_property_node_t *parent_node, const char *key, uint16_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_s32_create_t)(const core_property_node_t *parent_node, const char *key, int32_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_u32_create_t)(const core_property_node_t *parent_node, const char *key, uint32_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_s64_create_t)(const core_property_node_t *parent_node, const char *key, int64_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_u64_create_t)(const core_property_node_t *parent_node, const char *key, uint64_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_bin_create_t)(const core_property_node_t *parent_node, const char *key, void *data, size_t len, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_str_create_t)(const core_property_node_t *parent_node, const char *key, const char *value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_ipv4_create_t)(const core_property_node_t *parent_node, const char *key, uint32_t value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_float_create_t)(const core_property_node_t *parent_node, const char *key, float value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_double_create_t)(const core_property_node_t *parent_node, const char *key, double value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_attr_create_t)(const core_property_node_t *parent_node, const char *key, const char *value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_bool_create_t)(const core_property_node_t *parent_node, const char *key, bool value, core_property_node_t **node_out);
typedef core_property_node_result_t (*core_property_node_s8_read_t)(const core_property_node_t *parent_node, int8_t *value);
typedef core_property_node_result_t (*core_property_node_u8_read_t)(const core_property_node_t *parent_node,  uint8_t *value);
typedef core_property_node_result_t (*core_property_node_s16_read_t)(const core_property_node_t *parent_node, int16_t *value);
typedef core_property_node_result_t (*core_property_node_u16_read_t)(const core_property_node_t *parent_node, uint16_t *value);
typedef core_property_node_result_t (*core_property_node_s32_read_t)(const core_property_node_t *parent_node, int32_t *value);
typedef core_property_node_result_t (*core_property_node_u32_read_t)(const core_property_node_t *parent_node, uint32_t *value);
typedef core_property_node_result_t (*core_property_node_s64_read_t)(const core_property_node_t *parent_node, int64_t *value);
typedef core_property_node_result_t (*core_property_node_u64_read_t)(const core_property_node_t *parent_node, uint64_t *value);
typedef core_property_node_result_t (*core_property_node_bin_read_t)(const core_property_node_t *parent_node, void *value, size_t len);
typedef core_property_node_result_t (*core_property_node_str_read_t)(const core_property_node_t *parent_node, char *value, size_t len);
typedef core_property_node_result_t (*core_property_node_ipv4_read_t)(const core_property_node_t *parent_node, uint32_t *value);
typedef core_property_node_result_t (*core_property_node_float_read_t)(const core_property_node_t *parent_node, float *value);
typedef core_property_node_result_t (*core_property_node_double_read_t)(const core_property_node_t *parent_node, double *value);
typedef core_property_node_result_t (*core_property_node_attr_read_t)(const core_property_node_t *parent_node, char *value, size_t len);
typedef core_property_node_result_t (*core_property_node_bool_read_t)(const core_property_node_t *parent_node, bool *value);
