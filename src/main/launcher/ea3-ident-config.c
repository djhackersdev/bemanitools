...
PSMAP_OPTIONAL(PSMAP_TYPE_STR, struct ea3_ident_config, softid, "/id/softid", "")
PSMAP_OPTIONAL(PSMAP_TYPE_STR, struct ea3_ident_config, hardid, "/id/hardid", "")
...
void ea3_ident_config_load(struct property *property, struct ea3_ident_config *config)
{
    ...
    if (!property_psmap_import(property, node, config, ea3_ident_config_psmap)) {
