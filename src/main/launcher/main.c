...
int main(int argc, const char **argv)
{
    ...
    log_misc("Creating file system directories for nvram and raw if not exist...");

    // create nvram and raw directories if possible for non-mounttable configurations
    create_avs_config_fs_dir(avs_config, avs_config_root, "nvram");
    create_avs_config_fs_dir(avs_config, avs_config_root, "raw");
