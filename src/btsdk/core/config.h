#ifndef BTSDK_CORE_CONFIG_H
#define BTSDK_CORE_CONFIG_H

#include "btpi/core/config.h"

void bt_core_config_impl_set(const bt_core_config_impl_t *impl);

const char *bt_core_config_result_to_str(core_config_result_t result);
void bt_core_config_fatal_on_error(core_config_result_t result);
